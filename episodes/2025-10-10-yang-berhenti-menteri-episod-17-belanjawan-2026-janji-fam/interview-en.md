...
Unfortunately, most budget reports and analyses in the media often set aside these primary documents and focus only on the speech text. The speech text is merely a summary that is, of course, drafted to portray the budget as the best thing the government has to offer. That is why I will always look at the macro aspects first before making further analysis. Ultimately, the most important thing we want to see in a budget is whether the spending planned by the government can be sustained by national revenue or not. The government can announce anything, but if it cannot be sustained, only a few possibilities will happen: either taxes are raised, national debt is increased, or the announced projects eventually cannot be implemented.

After we evaluate whether the expenditure can be sustained by revenue, only then can we analyze the allocation aspect and the *spending priority*. We need to see whether the allocation can balance the need to stimulate economic growth. If the economy grows well, wages will rise and the people will get better job opportunities and income. Subsequently, the government can collect taxes more effectively to be channeled back to help people in need. From there, we can evaluate whether the spending priority aligns with the right national development strategy.

Based on my quick reading earlier, there is one important point that is rarely raised by anyone. I brought up this issue about ten years ago. Our culture is often overshadowed by *short-termism* and a *short attention span*. When a budget is presented, we only focus on the figures for the coming year. For example, if we are currently discussing Budget 2026, we do not look back at what happened in 2025 at all. Yet, the performance figures for 2025 are very important to evaluate the government's efficiency in implementing policies and to see the changes that have occurred compared to the original projections presented a year ago. That is why in those hundreds of pages of documents, the figures for 2025 are no longer just the original projections; instead, they are shown as the "Revised Estimate". So, my first action was to reorganize the data to look at the latest projected figures for 2025 against last year's original budget figures before we discuss the projections for 2026. This comparison is what is rarely debated by the public.

For example, let's look at government revenue. When Budget 2025 was presented, government revenue was estimated at RM339.7 billion. However, in the document presented earlier, that revenue projection has been revised downward to RM334.1 billion. This means there is a revenue reduction of RM5.6 billion compared to the original estimate. A reduction of RM5.6 billion is a very large amount. By comparison, the Second Finance Minister previously announced that the implementation of the Budi Madani (Budi95) scheme, which was implemented with great difficulty, could only yield savings of around RM2.5 billion to RM4 billion a year.

When the revenue collection for 2025 is revised downward by almost 1.7%, it illustrates that tax collection—despite being bolstered by the implementation of SST and various other measures—did not reach the target estimated a year ago. This shows that our economic growth is currently undergoing a moderation. Taking into account this moderating economic trajectory, when Budget 2026 projects revenue of RM343.1 billion (which is an increase of RM9 billion compared to the revised 2025 projection), we must be cautious. Since economic growth is expected to moderate, corporate companies will pay lower tax rates, and some experiencing losses will not pay taxes at all. Therefore, the projected revenue increase of RM9 billion might not be fully achieved.

In this situation of uncertain revenue, we must also look at how the government spends. Generally, government spending continues to show an increase. Spending for 2025 is projected to decrease by RM2.8 billion (or about 0.85%) compared to the original estimate. Nevertheless, if observed, the rate of reduction in national revenue is far more drastic than the rate of reduction in expenditure. This is an issue that needs attention. For next year, spending is expected to increase by another RM6 billion, whereas the risk of revenue reduction is higher compared to our potential to reduce operating expenditure.

For the next macro aspect, my attention turns to Development Expenditure (DE). For the viewers' information, government spending is divided into two main categories, similar to the concepts of OPEX and CAPEX in a private organization. Operating Expenditure (OE) is equivalent to OPEX, involving operating costs such as staff salaries, utility bills, and non-capital expenses that do not produce direct returns. Meanwhile, Development Expenditure (DE) is equivalent to CAPEX (capital expenditure), which involves investments to build assets or projects that can add value and generate new income for the country.

In the public sector, Operating Expenditure (OE) consists of several main components such as emoluments (civil servants' salaries), pensions, transfer payments to state governments and public agencies, and supplies (costs of office management, events, and utilities). Two other main components that are always the focus of the people are the *debt service charge*, which is the interest payment on government loans, and subsidies and social assistance (such as the Sumbangan Tunai Rahmah [STR] program, Sumbangan Asas Rahmah [SARA], JKM assistance, as well as fuel and electricity subsidies). Meanwhile, Development Expenditure (DE) is used to build schools, roads, hospitals, and to channel business assistance grants.

My main concern when looking at the budget documents presented earlier is that there are indications that, for the sake of reducing the national deficit rate, Development Expenditure (DE) is being sacrificed. Based on the performance in 2025, we face challenges in implementing development projects as planned. The DE allocation approved for 2025 was originally RM84.7 billion, but the revised projection presented earlier shows only RM78.7 billion is expected to be spent. This means there is RM6 billion in development allocation that was unspent. This situation could be due to the government's decision to restrict such spending to meet deficit targets, or the failure of implementing agencies to spend the allocation because projects did not pass the *milestones* set for payment claims. Both of these situations are actually a problem.

Under the provisions of the Federal Constitution, the government is not allowed to borrow or go into debt to finance Operating Expenditure (OE). Loans can only be made to finance Development Expenditure (DE). Therefore, the national deficit rate (measured as a percentage of Gross Domestic Product [GDP]) is closely linked to the amount of new debt issued for DE. For example, if the deficit rate is 5% of our economy's size, which is worth around RM1.7 trillion, the amount is roughly over RM80 billion. This increase in new debt will subsequently burden Operating Expenditure (OE) in the coming years through increased interest payments (*debt service charge*). Consequently, the government's room to borrow in the future will become narrower, thus shrinking the allocation for the country's physical development.

For 2026, the DE allocation is estimated at RM79.5 billion. Although there is a slight increase compared to the revised 2025 estimate (RM78.7 billion), this amount actually registers a 6% reduction when compared to the original planning of Budget 2025. A 6% reduction in development allocation within a single year is a very large amount. Yet, this DE allocation is crucial as a *catalyst* to stimulate industrial investment and the country's economic growth.

Another critical aspect that worries me deeply is the increase in the *debt service charge*. For 2025, the amount that needs to be paid for debt interest alone is RM54.3 billion. To understand whether this amount is large or small, we can compare it to the total Operating Expenditure (OE) for 2025, which is valued at RM332 billion, representing about 17%. As a simple analogy, if our monthly salary is RM2,000, 17% of that income (which is RM340) is used solely to pay credit card interest, excluding the principal payment. Such a financial situation is very dire. According to international financial standards, a country's debt service charge should not exceed 15% of total revenue. However, with interest payments of RM54.3 billion out of national revenue worth RM334 billion, we have clearly exceeded that 15% limit over the last year or two.

For 2026, these debt interest payments are expected to continue rising by 7% to RM58.3 billion, which is an increase of RM4 billion within a year. This means that despite all the difficulties faced in implementing subsidy targeting programs like Budi Madani to save around RM2.5 billion to RM4 billion annually, that savings amount is still insufficient to cover the increase in the country's annual debt interest payments, which surged by RM4 billion.

Finally, let's look at the subsidies and social assistance component. From one perspective, the government has indeed successfully reduced the country's subsidy commitments. From the records I recall, the country's subsidies and social assistance burden in 2023 was around over RM60 billion. This amount has decreased to around RM57 billion in 2025, and is projected to continue dropping by RM8 billion to RM49 billion for 2026.
...
This is the *big picture* that we need to understand first before we get busy discussing small allocations of RM10 million or RM20 million here and there. In reality, the number one problem of our national finances today is the extremely high debt burden. If we continue to add RM4 billion to RM5 billion in debt interest payments every year, it will constrain our ability to spend that money on development that is more beneficial to the people.

Perhaps the Ministry of Finance or Treasury would argue that this is a *chicken and egg* scenario; where we have to reduce subsidies first to lower the deficit rate. However, after almost four years of discussing this, our original goal of implementing subsidy targeting was to create a *fiscal glide* path. Through this path, the deficit rate can be lowered gradually (from 5% to 4% and subsequently 3%), which will eventually reduce the growth of the national debt. Savings from the reduction in debt interest payments are what should give us wider fiscal space to increase Development Expenditure (DE) to build schools, hospitals, and infrastructure more quickly. Alright, now it's time for me to take a break and have a drink of water first.
...
So, the main focus seems to be more on collecting taxes. However, we hear less about how we are going to manage national spending differently compared to past practices, *without spending enough time talking about how we are going to do it differently.* If Datuk Seri Anwar were here—even in Parliament earlier, his speech started on a high note regarding the aspect of governance. *Yeah, I think nobody is disputing that.* That is what the people have been demanding for a long time. We want to see how the government manages spending better so that there are no leakages, no corruption, and government tenders get the best prices. We hear less about these sorts of things from this budget, other than just grand slogans about governance.

The people, especially taxpayers, surely feel they now have to pay higher taxes than before. *So I want to see more of what is being done for me to get the confidence that you are going to manage this better.* Otherwise, another thing I worry about regarding this expenditure is the country's debt ratio, which does not seem to show signs of slowing down despite the implementation of SST and other measures.

For 2026, our debt ratio is expected to exceed 64%—I estimate around 64.2% or 64.3%—whereas our *debt ceiling* is 65%. That *ceiling* limit was actually raised during the PN administration in 2021. Ten years ago, when I first became an MP, the *ceiling* was only at 55%. When we compare it with equivalent *upper-middle income* countries, Malaysia's debt ratio is actually high. The 65% level is high, whereas Indonesia is only around 40%. A country that successfully transitioned from *upper-middle income* to *high income* like Chile—which has often been an international reference point in the last 10 years—has a debt ratio of only about over 30% of their GDP size.

Given that our debt ratio for next year is already nearing the 65% *ceiling*, the budget presented is actually based on certain assumptions, including the assumption that the country's economy will grow by around 4.5% to 5%. However, market projections for 2025 are actually in the *low 4%* range, around 4.2%. So, if any economic shock occurs—and the budget documents themselves outline several scenarios if changes occur in global economic growth or interest rates—this means the margin we have to avoid breaching the *debt ceiling* is very narrow.

If economic growth drops below the 4% level and tax collections are lower than targeted, the government will only have limited options: either go to Parliament to raise the *debt ceiling* again, or cut spending on the infrastructure and development sectors. If development spending is cut, it will directly impact the country's economic growth and create an ongoing *vicious cycle* chain.

That is why we need to scrutinize our revenue and expenditure trends. In terms of revenue, there are both good and bad aspects. The good side is that, unlike the situation 10 to 15 years ago, we are no longer overly dependent on petroleum revenue. In 2008, which was almost 20 years ago, petroleum revenue contributed nearly 40% of the nation's income. Now, that contribution has fallen below the 20% level. Today, the largest contributor to national revenue comes from direct taxes like income tax, indirect taxes like SST and excise duty, as well as non-tax revenue such as dividends from Petronas and government-linked companies (GLCs). 

*So in that sense, on the one hand,* after 20 years, the government's revenue structure is seen as more stable. If we were to rely solely on oil revenue, it would be extremely dangerous for the country, as has happened to several Arab nations where a drop in oil prices below a certain level impacts their ability to fund national expenditures. We have successfully moved past that phase. 

At the same time, however, our revenue collection remains low relative to GDP, which is below the 15% mark—only around 12%. Some attribute this to loopholes in the tax system that allow certain groups to avoid paying taxes, which is why LHDN is actively pursuing taxpayers. On the other hand, it could be due to the underperformance of our domestic economic sector, resulting in corporate profits not being as large as expected to contribute higher taxes to the country. 

Finally, what I find lacking in this budget is a radical effort to manage the budget and government spending differently to transform the country's socioeconomic structure so that the same problems do not keep recurring. My concern is that if we continue to manage it on a business-as-usual basis, we will still not see a clear way out on how to reduce our debt level to prevent it from approaching the 65% debt ceiling, as well as how to save RM10 billion to RM15 billion from debt interest payments every year. 

This is what should be the main focus moving forward. Insya-Allah, it is my role to continue voicing this. Just like the subsidy retargeting issue that I championed previously—even though its implementation method is now different—at least that step has begun. However, the results of this subsidy retargeting in terms of reducing national debt and interest payments are not yet visible at this moment.
...
For now, our cash aid system—what is called the social safety net—is still not fully institutionalized. By institutionalized, I mean something like the schooling system for children; when we register a child for school, we do not need to apply separately to get that right to education because it is provided universally, while additional aid will be funneled directly to those who qualify. We have not reached that level yet in managing social aid within our government system. 

So far, STR or SARA is still seen as a continuation of the previous BR1M program. If there is a change of government in the future, its name might change again to another branding, no longer STR or SARA. Even before SARA, we used the name BSH...
...
Let's look at the first question from Ridwan: *"YB was the individual who drove the JS-SEZ (Johor-Singapore Special Economic Zone) effort in the early stages, but now YB is rumored to have resigned. In YB’s view, will the JS-SEZ really succeed? If yes, what is the vision for the next 3 to 5 years, and what are the transparent KPIs besides Ringgit figures, for example in terms of median wage growth, local hire, and worker value-add? If not managed well, what are the main risks—is it in terms of land play, an influx of cheap labor, rising rental prices, or congestion? What guardrails should be put in place starting from now?"* 
...
JS-SEZ has immense potential. As for the question of whether it will really succeed, the impact is already beginning to show, particularly in terms of investment inflows and rising property values in Johor. Many government-linked companies and property companies have enjoyed profits from the appreciation of land value there. 

Our vision is to see JS-SEZ succeed in becoming an economic catalyst like some of the economic zones we modeled in China. One of the models we emulated, other than Shenzhen, is the Suzhou Industrial Park, which I have personally visited. This project is considered successful if it can attract and house a new generation of high-tech companies from around the world—whether world-class companies from China, the United States, or Europe. 

Once this ecosystem is formed, it will attract international talent, which in turn will boost the quality of the nation's economy. If this planning goes smoothly over the next 10 to 15 years, Malaysia has the potential to become the main heartbeat of the Southeast Asian market, which has a population density of around 700 to 800 million people, thereby putting us in the group of the top five largest economic regions in the world. 

Specific KPIs for JS-SEZ have indeed been formulated. In the draft of the previous negotiation agreement—which was among the most challenging phases of negotiations between the Malaysian and Singaporean governments—we set a target of at least 50 projects in the early stages, before increasing it to 100 projects after a five-year period under strict criteria. The Singaporean side and several ministries initially questioned these overly specific KPIs because the usual practice for establishing economic zones is to let them grow organically. However, we stood firm on setting those KPIs. If these targets are met, positive impacts like median wage growth and local hire rates will follow naturally as a result of the quality of investments brought in. 

On the contrary, if we do not manage it carefully, the project will ultimately fail to achieve its goals and investors will not come. It will just become a typical industrial area where factories are built haphazardly without forming a strong ecosystem or economic nucleus. JS-SEZ should not be evaluated over just one or two years, as it is a long-term plan for the next 10 to 20 years.
...
As for RMK-13, major issues such as the national debt level and financial capability might be seen by the Ministry of Finance as a continuation of the efforts they have started. However, my concern is that the national debt target figure seems to be rising towards the 64.9% level. 

It is very difficult for us to evaluate the alignment of this budget with the RMK-13 plan based solely on the budget speech document. If we examine the Federal Government Expenditure Estimates book, details of development projects are not shown comprehensively due to confidentiality factors. For example, the allocation of RM550 million for the Ministry of Agriculture is not specified as to what projects it is for. 

Therefore, we cannot evaluate the effectiveness of this policy holistically just from the text of the budget speech. I see this budget as more of an annual continuation of the previous budget, rather than a document that embraces the aspirations of RMK-13 and prioritizes major structural reforms. For example, in terms of educational reform; other than allocations for school construction and repairs, which are routine annual projects, we have not heard any specific details regarding efforts to improve the quality of education, such as plans to dedicate parts of the Teacher Education Institutes (IPG) for Continuous Professional Development (CPD) programs for teachers. Details like this are still vague, but they can be brought up and debated in Parliament later.
...
Just like the government, Petronas also requires high capital expenditure (*capex*) to ensure the production of hundreds of thousands of barrels of oil per day can be maintained. They need around RM40 billion a year to explore or develop new oil blocks. If the government takes an additional RM10 billion dividend from their reserves, Petronas' cash balance will decrease, and they will be forced to cancel some exploration projects. 

This situation will trigger a *vicious cycle* where a reduction in exploration activities today will affect the company's revenue for the next three to five years. Coupled with the current low crude oil prices of around 60 dollars a barrel as well as fierce global competition, the government indeed has no choice but to reduce dependence on Petronas revenue.
...
However, to answer the question of whether ministers should be paid higher to prevent corruption: I do not agree with that argument. For example, when I was a minister, the net salary I received was around RM37,000 a month after tax deductions and other cuts. Even if that amount was increased by RM5,000 to RM42,000, it still would not stop a minister from committing corruption if they already have bad intentions to make a profit. 

The core issue here is not merely the salary value, but it is closely linked to our national political culture. Someone who chooses to be a minister must be willing to serve the country and not be motivated by getting rich. A net salary of RM35,000 a month is more than enough to cover monthly expenses; even I, who keep 20 cats, can still live comfortably with that amount. 

The main problem in our political landscape is the existence of a culture where supporters and the public constantly demand direct financial contributions or aid from politicians. During the previous party elections, some claimed that I did not take care of the grassroots members' welfare because I didn't give them money. But I only had a net income of RM35,000 a month, and after covering various personal commitments, I certainly did not have additional funds to distribute randomly like that. 

If this money-giving political culture is not stopped, even if you pay ministers RM100,000 a month, they will still find a way to commit corruption to meet the political demands of supporters on the ground. Therefore, raising ministers' salaries will not curb corruption as long as we do not tighten anti-corruption laws involving politicians, and as long as top leaders do not set a good example by stopping the culture of handing out cash. 

The public and politicians at the grassroots level also need to change their mindset; do not assume that when a party succeeds in forming the government, it is an opportunity to reap profits or collect political funds. We should judge the quality of a leader or a government based on their effectiveness and efficiency in working for the people, not on the amount of political allocations or cash they can dish out.
...
Insya-Allah, in the next two to three weeks, we will launch these stores. The opening process takes quite a while because we have to find strategic locations, carry out renovation work, register the business, and apply for various related licenses from local authorities. For now, our preparations have reached around 70% and are in the final 30% phase. Although we experienced a slight delay of around three to four weeks from the original two-month timeline I set for the team, it is normal given the tight work schedule. 

Before the official launch, I want to ensure everything runs smoothly. I have personally tested the food quality twice but am still not fully satisfied with the taste and consistency of the dishes. This weekend, I will discuss with my wife to finalize the recipes and menu for the Kesum outlet. We are targeting an official opening in the third or fourth week of this October. 

I chose to focus on these two pilot projects first because they involve relatively large investment costs out of our own pockets, and we want to ensure the profit margin calculation for the RM5 selling price is truly accurate and sustainable before expanding it. Once this operating template is proven successful, only then will we open up opportunities for the public to participate in opening them in their respective areas. 

At the same time, for other *social enterprise* projects like the "Pinjam Gadget" initiative, we have successfully collected the first 17 laptop units to be refurbished for the use of students from low-income families. As for the modern agriculture project, we have received offers of seven to eight land plots from private landowners who are interested in collaborating. I chose to postpone the launch of these other projects until November to focus fully on establishing the Kesum and FlexiMart stores first.
