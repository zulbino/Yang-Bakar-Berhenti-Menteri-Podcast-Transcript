...
Generated by `scripts/qa_check.py`. 63/67 processed episodes clean, 4 flagged, 0 not yet processed.

2 issue(s) across 2 episode(s) were reviewed and judged benign -- see the section at the end, and `data/qa_reviewed.json` for the rationale. Delete an entry there to re-flag it.
...
- [ ] **2025-05-10-ep00-podcast-yang-berhenti-menteri**
  - raw.md is missing content from the middle (3249s unexplained across 4 gap(s), 41% of the episode; worst is 1097s at 4096s -> 5238s) -- gaps too large for the text at their start, see ARCHITECTURE.md 1.17
  - raw.md has 5 duplicate block(s) repeated verbatim at different timestamps (814 chars, 1% of raw.md) -- likely a continuation-loop hallucination, not a transcription error
  - check_timestamp_drift.py flagged timestamp mistiming (max drift 446s, 11/12 caption samples matched)
  - raw.md has no counterpart for 3060s of captioned speech (4800s->7860s; episode baseline 23%) -- content absent from the transcript rather than merely mistimed, see ARCHITECTURE.md 1.25
- [ ] **2025-12-12-ep26-reformasi-bukan-content-azam-baki-uec-felda-ybm-ep-26**
  ...
  - raw.md has no counterpart for 2940s of captioned speech (4980s->7920s, 7980s->8880s; episode baseline 13%) -- content absent from the transcript rather than merely mistimed, see ARCHITECTURE.md 1.25
...
- [ ] **2026-05-15-ep48-penyasaran-subsidi-t20-kereta-ev-import-dan-hala-tuju-politi**
  - raw.md has no counterpart for 2100s of captioned speech (9000s->11100s; episode baseline 28%) -- content absent from the transcript rather than merely mistimed, see ARCHITECTURE.md 1.25
  - models: raw.md=gemini-3.5-flash, interview.md=claude-sonnet-5, interview-en.md=claude-sonnet-5, interview-ms.md=claude-sonnet-5
