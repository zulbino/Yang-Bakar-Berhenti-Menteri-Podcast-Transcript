...
from common import (artifact_tag, episode_path, episode_slug, frontmatter_md,
                    read_frontmatter_body, resolve_tag)
...
def main():
    ...
    align_path = Path(a.align) if a.align else ROOT / "data" / f"_{artifact_tag(a.tag)}_align.json"
